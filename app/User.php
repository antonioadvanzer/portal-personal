...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'apellido_paterno', 'apellido_materno', 'photo', 'email', 'password', 'status', 'nomina', 'plaza', 'area', 'posicion_track', 'company', 'fecha_ingreso', 'fecha_baja', 'fecha_reingreso','tipo_baja', 'motivo'
    ];
