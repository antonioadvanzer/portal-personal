<uib-accordion>
  <uib-accordion-group heading="Portal Intranet Advanzer - Entuizer" panel-class="panel-primary bootstrap-panel accordion-panel">
        ...
        <div ba-panel ba-panel-class="banner-column-panel">
          <div class="banner">
            <div class="large-banner-wrapper">
              <img ng-src="@{{::( 'app/main/imac-wallpaper-2560x1440.jpg' | appImage )}}" alt=""/>
            </div>
  ...
  <uib-accordion-group heading="Plataforma de Educaci&oacute;n a Distancia Advanzer - Entuizer" panel-class="panel-success bootstrap-panel accordion-panel">
  ...
  <uib-accordion-group heading="Captura de Asignaciones en Harvest" panel-class="panel-info bootstrap-panel accordion-panel">
      ...
      <div class="col-xlg-3 col-lg-12 col-sm-6 col-sm-6">
        <div ba-panel ba-panel-class="banner-column-panel">
          <div class="banner">
            <div class="large-banner-wrapper">
              <img ng-src="@{{::( 'app/main/horario de oficina.jpg' | appImage )}}" alt=""/>
            </div>
            <div class="banner-text-wrapper">
              <div class="banner-text">
