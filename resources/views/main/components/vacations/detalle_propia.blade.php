    ...
    <div class="row">
        <div class="col-md-12">
            <div class="input-group">
                ...
                <textarea placeholder="" class="form-control" id="inputOwnRequestObservaciones" name="inputOwnRequestObservaciones" ng-model="formOwnRequest.inputOwnRequestObservaciones" readonly>@{{formOwnRequest.inputAbsenceReceivedObservaciones}}</textarea>
            </div>
