    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="input-group" align="center">
                ...
                <div ng-show="fformOwnRequest.inputOwnRequestAuthCh == 1" class="alert bg-success col-md-4" align="center"><!--<i class="ion-android-checkmark-circle"></i>--><h3>Autorizado</h3></div>
