<div class="horizontal-scroll">
  ...
  <table class="table table-hover table-condensed" st-table="requisitions_table.todasLasRequisiciones" st-safe-src="requisitions_table.requisiciones">
    ...
    <tbody>
    <tr ng-repeat="sl in requisitions_table.todasLasRequisiciones" ng-click="showRequisitionDetail(sl.id)" ng-class="{'primary': ((sl.alert == 1) && (sl.status == 4))}">
    ...
    <div ng-if="!requisitions_table.todasLasRequisiciones.length" class="alert bg-warning text-center">
