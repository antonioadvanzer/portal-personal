<div class="horizontal-scroll">
  ...
  <table class="table table-hover table-condensed" st-table="requisitions_table.requisicionesEnProceso" st-safe-src="requisitions_table.enproceso">
    ...
    <tbody>
    <tr ng-repeat="sl in requisitions_table.requisicionesEnProceso" ng-click="showRequisitionDetail(sl.id)" ng-class="{'primary': ((sl.alerta == 1) && (sl.status == 4))}" class="row-table">
