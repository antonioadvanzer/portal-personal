<div class="horizontal-scroll">
  ...
  <table class="table table-hover table-condensed" st-table="requisitions_table.requisicionesAutorizadas" st-safe-src="requisitions_table.autorizadas">
    ...
    <tbody>
    <tr ng-repeat="sl in requisitions_table.requisicionesAutorizadas" ng-click="showRequisitionDetail(sl.id)" ng-class="{'primary': ((sl.alerta == 1) && (sl.status == 4))}">
    ...
    <div ng-if="!requisitions_table.requisicionesAutorizadas.length" class="alert bg-warning text-center">
