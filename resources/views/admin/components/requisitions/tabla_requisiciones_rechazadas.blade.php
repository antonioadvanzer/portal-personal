<div class="horizontal-scroll">
  ...
  <table class="table table-hover table-condensed" st-table="requisitions_table.requisicionesRechazadas" st-safe-src="requisitions_table.rechazadas">
    ...
    <tbody>
    <tr ng-repeat="sl in requisitions_table.requisicionesRechazadas" ng-click="showRequisitionDetail(sl.id)" ng-class="{'primary': ((sl.alerta == 1) && (sl.status == 4))}">
    ...
    <div ng-if="!requisitions_table.requisicionesRechazadas.length" class="alert bg-warning text-center">
