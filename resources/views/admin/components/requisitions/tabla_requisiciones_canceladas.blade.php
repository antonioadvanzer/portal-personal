<div class="horizontal-scroll">
  ...
  <table class="table table-hover table-condensed" st-table="requisitions_table.requisicionesCanceladas" st-safe-src="requisitions_table.canceladas">
    ...
    <tbody>
    <tr ng-repeat="sl in requisitions_table.requisicionesCanceladas" ng-click="showRequisitionDetail(sl.id)" ng-class="{'primary': ((sl.alerta == 1) && (sl.status == 4))}">
    ...
    <div ng-if="!requisitions_table.requisicionesCanceladas.length" class="alert bg-warning text-center">
