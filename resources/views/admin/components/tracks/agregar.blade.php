<form name="newTrack" ng-submit="save()">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="inputTrackName" name="inputTrackName" ng-model="track.inputTrackName" placeholder="" required>
