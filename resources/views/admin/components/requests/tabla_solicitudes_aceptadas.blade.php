<div class="horizontal-scroll">
  ...
  <table class="table table-hover table-condensed" st-table="requests_table.solicitudesAceptadas">
    <thead>
    <tr class="sortable ">
    ...
    <tbody>
    <tr ng-repeat="sa in requests_table.solicitudesAceptadas" ng-click="showRequest(sa.id)" ng-class="{'primary': ((sa.alerta == 1) && (sa.status == 3))}">
