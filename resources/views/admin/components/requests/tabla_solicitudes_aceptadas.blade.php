  ...
  <div class="form-group select-page-size-wrap ">
    <label>Filas por pagina
      <select class="form-control selectpicker show-tick" title="Rows on page" selectpicker
              ng-model="tamanioTablaSolicitudesAceptadas" ng-options="i for i in [5,10,15,20,25]">
      </select>
    </label>
  </div>
  <table class="table table-hover table-condensed" st-table="solicitudesAceptadas">
    <thead>
    <tr class="sortable ">
    ...
    <tbody>
    <tr ng-repeat="sa in solicitudesAceptadas" ng-click="showRequest(sa.id)" ng-class="{'primary': ((sa.alerta == 1) && (sa.status == 3))}">
    ...
    <tr>
      <td colspan="6" class="text-center">
        <div st-pagination="" st-items-by-page="tamanioTablaSolicitudesAceptadas" st-displayed-pages="5"></div>
      </td>
    </tr>
    </tfoot>
  </table>
