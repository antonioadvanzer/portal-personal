<ul class="al-msg-center clearfix">
  ...
  {{--<li uib-dropdown>
    <a href uib-dropdown-toggle>
      <i class="fa fa-bell-o"></i><span>@{{ (notification.cant_vacations_sended -- notification.cant_absences_sended -- notification.cant_requisitions_sended --  notification.cant_vacations_received -- notification.cant_absences_received -- notification.cant_requisitions_received) }}</span>
