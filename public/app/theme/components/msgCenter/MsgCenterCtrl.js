...
(function () {
  ...
  function MsgCenterCtrl($scope, $sce, $http) {
      ...
      $scope.refreshNotifications = function(){
          ...
          $scope.getCountAbsencesRequestReceived().then(function(data){
              $scope.notification.cant_absences_received = data;
          });
          
          $scope.getCountRequisitionsRequestReceived().then(function(data){
              $scope.notification.cant_requisitions_received = data;
          });
