...
/* Solicitudes table -------------------------------------------------------------------------------*/
    ...
    //function getAllRequest(){
        return $http.get("admin-theme/modules/request/get_all_requests_absence").then(function (response) {
    ...
    //function getCanceledRequest(){
        return $http.get("admin-theme/modules/request/get_canceled_requests_absence").then(function (response) {
    ...
    //function getSendedRequest(){
        return $http.get("admin-theme/modules/request/get_sended_requests_absence").then(function (response) {
    ...
    //function getAceptedRequest(){
        return $http.get("admin-theme/modules/request/get_acepted_requests_absence").then(function (response) {
    ...
    //function getRejectedRequest(){
        return $http.get("admin-theme/modules/request/get_rejected_requests_absence").then(function (response) {
    ...
    //function getAutorizedRequest(){
        return $http.get("admin-theme/modules/request/get_authorized_requests_absence").then(function (response) {
...
/* Show formRequest Recived ------------------------------------------------------------------------------------*/
    ...
    $scope.authRequest = function (){
        ...
        $http.get("admin-theme/modules/request/auth_request/"+$scope.formRequest.inputRequestId).then(function (response) {
            ...
            $scope.sending = false;
            $scope.refreshTables();
            resetForm("permisos_de_ausencia.toda_las_solicitudes");
